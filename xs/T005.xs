...
MODULE = Qt::Multimedia			PACKAGE = Qt::Multimedia::Template::T005
PROTOTYPES: DISABLE
...
QList<QVideoFrame::PixelFormat> * arg10;
PPCODE:
    switch(items) {
      case 1:
      {
    ...
    ret = new QList<QVideoFrame::PixelFormat>();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Multimedia::Template::T005", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
      case 2:
      {
        if (sv_isa(ST(1), "Qt::Multimedia::Template::T005")) {
      arg10 = reinterpret_cast<QList<QVideoFrame::PixelFormat> *>(SvIV((SV*)SvRV(ST(1))));
    ret = new QList<QVideoFrame::PixelFormat>(*arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Multimedia::Template::T005", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    XSRETURN(0);
        ...
        else if (sv_isa(ST(1), "Qt::Multimedia::Template::T005")) {
      arg10 = reinterpret_cast<QList<QVideoFrame::PixelFormat> *>(SvIV((SV*)SvRV(ST(1))));
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    const QVideoFrame::PixelFormat & ret = THIS->at(arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    switch(items) {
      ...
      {
        if (SvIOK(ST(1))) {
      arg10 = (QVideoFrame::PixelFormat)SvIV(ST(1));
...
PREINIT:
int arg00;
QVideoFrame::PixelFormat arg01;
PPCODE:
    if (SvIOK(ST(1)) && SvIOK(ST(2))) {
      arg00 = (int)SvIV(ST(1));
      arg01 = (QVideoFrame::PixelFormat)SvIV(ST(2));
...
T005::isSharedWith(...)
PREINIT:
QList<QVideoFrame::PixelFormat> * arg00;
PPCODE:
    if (sv_isa(ST(1), "Qt::Multimedia::Template::T005")) {
      arg00 = reinterpret_cast<QList<QVideoFrame::PixelFormat> *>(SvIV((SV*)SvRV(ST(1))));
...
PPCODE:
    if (sv_isa(ST(1), "Qt::Multimedia::Template::T005")) {
      arg00 = reinterpret_cast<QList<QVideoFrame::PixelFormat> *>(SvIV((SV*)SvRV(ST(1))));
    QList<QVideoFrame::PixelFormat> ret = THIS->operator=(*arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QVideoFrame::PixelFormat & ret = THIS->operator[](arg00);
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)ret);
    XSRETURN(1);
    }
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QVideoFrame::PixelFormat ret = THIS->takeAt(arg00);
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    QVideoFrame::PixelFormat ret = THIS->takeFirst();
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    QVideoFrame::PixelFormat ret = THIS->takeLast();
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)ret);
    XSRETURN(1);
    }
