...
MODULE = Qt::Multimedia			PACKAGE = Qt::Multimedia::Template::T002
PROTOTYPES: DISABLE
...
T002::new(...)
PREINIT:
QList<QAudioFormat::SampleType> *ret;
QList<QAudioFormat::SampleType> * arg10;
PPCODE:
    switch(items) {
      case 1:
      {
    ...
    ret = new QList<QAudioFormat::SampleType>();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Multimedia::Template::T002", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
      case 2:
      {
        if (sv_isa(ST(1), "Qt::Multimedia::Template::T002")) {
      arg10 = reinterpret_cast<QList<QAudioFormat::SampleType> *>(SvIV((SV*)SvRV(ST(1))));
    ret = new QList<QAudioFormat::SampleType>(*arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Multimedia::Template::T002", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    XSRETURN(0);
        ...
        else if (sv_isa(ST(1), "Qt::Multimedia::Template::T002")) {
      arg10 = reinterpret_cast<QList<QAudioFormat::SampleType> *>(SvIV((SV*)SvRV(ST(1))));
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    const QAudioFormat::SampleType & ret = THIS->at(arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    switch(items) {
      ...
      {
        if (SvIOK(ST(1))) {
      arg10 = (QAudioFormat::SampleType)SvIV(ST(1));
...
PREINIT:
int arg00;
QAudioFormat::SampleType arg01;
PPCODE:
    if (SvIOK(ST(1)) && SvIOK(ST(2))) {
      arg00 = (int)SvIV(ST(1));
      arg01 = (QAudioFormat::SampleType)SvIV(ST(2));
...
T002::isSharedWith(...)
PREINIT:
QList<QAudioFormat::SampleType> * arg00;
PPCODE:
    if (sv_isa(ST(1), "Qt::Multimedia::Template::T002")) {
      arg00 = reinterpret_cast<QList<QAudioFormat::SampleType> *>(SvIV((SV*)SvRV(ST(1))));
...
PPCODE:
    if (sv_isa(ST(1), "Qt::Multimedia::Template::T002")) {
      arg00 = reinterpret_cast<QList<QAudioFormat::SampleType> *>(SvIV((SV*)SvRV(ST(1))));
    QList<QAudioFormat::SampleType> ret = THIS->operator=(*arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QAudioFormat::SampleType & ret = THIS->operator[](arg00);
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)ret);
    XSRETURN(1);
    }
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QAudioFormat::SampleType ret = THIS->takeAt(arg00);
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    QAudioFormat::SampleType ret = THIS->takeFirst();
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    QAudioFormat::SampleType ret = THIS->takeLast();
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)ret);
    XSRETURN(1);
    }
